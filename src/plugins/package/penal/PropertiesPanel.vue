  ...
  <div class="process-panel__container" :style="{ width: `${width}px` }">
    ...
    <el-collapse v-model="activeTab">
      ...
      <el-collapse-item name="condition" v-if="elementType === 'Process'" key="message">
        <template #title>
          <div class="panel-tab__title">
            <el-icon><ChatDotSquare /></el-icon>消息与信号
          </div>
        </template>
      ...
      <el-collapse-item name="boundaryEvent" v-if="elementType.indexOf('BoundaryEvent') !== -1" key="boundaryEvent">
        <template #title>
          <div class="panel-tab__title">
            <el-icon><HelpFilled /></el-icon>定时边界事件
          </div>
        </template>
      ...
      <el-collapse-item name="listeners" key="listeners">
        <template #title>
          <div class="panel-tab__title">
            <el-icon><VideoCameraFilled /></el-icon>执行监听器
          </div>
        </template>
      ...
      <el-collapse-item name="taskListeners" v-if="elementType === 'UserTask'" key="taskListeners">
        <template #title>
          <div class="panel-tab__title">
            <el-icon><VideoCameraFilled /></el-icon>任务监听器
          </div>
        </template>
...
const initFormOnChanged = (element) => {
  ...
  if (!activatedElement) {
    ...
    activatedElement =
      registry.find(el => el.type === 'bpmn:Process') ??
