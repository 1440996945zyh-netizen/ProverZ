import { ElIcon, Menu } from 'element-plus' // 需确保项目中已导入图标组件
...
export const template = (isTaskListener) => {
  ...
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button">
      <el-button size="small" type="primary" icon="ep:plus" @click="openListenerForm(null)">添加监听器</el-button>
    </div>

    <!-- 监听器 编辑/创建 部分（Element Plus 移除 .sync，改用 v-model） -->
    ...
    <!-- 注入字段 编辑/创建 部分（修正笔误 + Element Plus 语法） -->
