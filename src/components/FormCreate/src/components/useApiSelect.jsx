...
import { isEmpty } from '@/utils/common/form-validation.js'


export const useApiSelect = (option) => {
    ...
    setup(props) {
      ...
      const buildSelect = () => {
        if (props.multiple) {
          ...
          return h('el-select', {
            ...
            h('el-option', { key: index, label: item.label, value: item.value })
          ))
        }
        return h('el-select', {
          class: 'w-1/1',
      ...
      const buildCheckbox = () => {
        ...
        return h('el-checkbox-group', {
          ...
          h('el-checkbox', { key: index, label: item.label, value: item.value })
        ))
      }
      ...
      const buildRadio = () => {
        ...
        return h('el-radio-group', {
          ...
          h('el-radio', { key: index, value: item.value }, item.label)
        ))
      }
      ...
      return () => {
        if (props.selectType === 'select') {
          ...
          return buildRadio()
        } else if (props.selectType === 'checkbox') {
