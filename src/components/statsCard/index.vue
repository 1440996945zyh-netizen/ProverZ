<template>
  <div class="statistics-container">
    <div 
      ...
      :style="getDynamicStyles(item, index)"
    >
...
.statistics-card {
  ...
  border: 1px solid 
    var(--normal-border-rgba, hsla(var(--primary-hue), var(--saturation), var(--lightness), var(--normal-border-alpha))) 
    !important;
  ...
  &:hover {
    ...
    // Hover边框：对应调整
    border-color: 
      var(--hover-border-rgba, hsla(var(--primary-hue), var(--saturation), var(--lightness), var(--hover-border-alpha))) 
      !important;
  }
}
