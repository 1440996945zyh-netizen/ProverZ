...
const api = {
  ...
  getList(query) {
    return request({
      url: '/api/v1/internal/sInportCar/getPageList',
      method: 'get',
      params: query,
    })
  },
  ...
  insert(data) {
    return request({
      url: `/api/v1/internal/sInportCar/addList`,
      method: 'post',
      data: data,
    })
  },
  ...
  deleteById(id) {
    return request({
      url: '/api/v1/internal/sInportCar/delete/' + id,
      method: 'delete'
    })
  },
  //删除
  ...
  exportExcel(query) {
    return request({
      url: '/api/v1/internal/sInportCar/exportExcel',
      method: 'get',
      responseType: 'blob',
      params: query,
    })
  ...
  downTemplate() {
    return request({
      url: '/api/v1/internal/sInportCar/downTemplate',
      method: 'get',
      responseType: 'blob',
    })
  },
  uploadFile(data) {
    return request({
      url: '/api/v1/internal/sInportCar/importList',
      method: 'post',
      data: data,
    })
  },
