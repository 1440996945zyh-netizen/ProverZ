...
const api = {
  ...
  getList(query) {
    return request({
      url: '/api/v1/internal/sPortStorage/getPageList',
      method: 'get',
      params: query,
    })
  },
  exportExcel(query) {
    return request({
      url: '/api/v1/internal/sPortStorage/exportExcel',
      method: 'get',
      responseType: 'blob',
      params: query,
    })
  ...
  insert(data) {
    return request({
      url: `/api/v1/internal/sPortStorage/addList`,
      method: 'post',
      data: data,
    })
  },
  ...
  deleteById(id) {
    return request({
      url: '/api/v1/internal/sPortStorage/delete/' + id,
      method: 'delete'
    })
  },
  //删除
  ...
  downTemplate() {
    return request({
      url: '/api/v1/internal/sPortStorage/downTemplate',
      method: 'get',
      responseType: 'blob',
    })
  },
  uploadFile(data) {
    return request({
      url: '/api/v1/internal/sPortStorage/importList',
      method: 'post',
      data: data,
    })
  },
