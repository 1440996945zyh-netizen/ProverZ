...
const api = {
  ...
  getList(query) {
    return request({
      url: '/api/v1/internal/sShipTrends/getPageList',
      method: 'get',
      params: query,
    })
  },
  exportExcel(query) {
    return request({
      url: '/api/v1/internal/sShipTrends/exportExcel',
      method: 'get',
      responseType: 'blob',
      params: query,
    })
  ...
  uploadFile(data) {
    return request({
      url: '/api/v1/internal/sShipTrends/importList',
      method: 'post',
      data: data,
    })
  },
  downTemplate() {
    return request({
      url: '/api/v1/internal/sShipTrends/downTemplate',
      method: 'get',
      responseType: 'blob',
    })
  },
  ...
  insert(data) {
    return request({
      url: `/api/v1/internal/sShipTrends/addList`,
      method: 'post',
      data: data,
    })
  },
  ...
  deleteById(id) {
    return request({
      url: '/api/v1/internal/sShipTrends/delete/' + id,
      method: 'delete'
    })
  },
  //删除
