...
// 后台url   /api/v1/internal/tStdWorkSafetyBanDetail
  ...
  getList(query) {
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBan/getList',
      method: 'get',
      params: query
    })
  },
  ...
  deleteBYProcessSystemID(data) {
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBan/delList',
      method: 'delete',
      data: data
    })
  },
  ...
  listSave(data){
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBan/dosave',
      method: 'post',
      data: data
    })
  },
  getWorktoolDetailList(data){
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBan/getAllList',
      method: 'post',
      data: data
    })
  },
  ...
  getBySystemIdAndProcessId(query) {
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBan/getBySystemIdAndProcessId',
      method: 'post',
      data: query,
    })
  },

  //列表   子表详细数据  getDetailList
  getDetailList(query) {
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBanDetail/getDetailList',
      method: 'post',
      data: query,
    })
  },
  ...
  addDetail(data){
    return request({
      url: '/api/v1/internal/tStdWorkSafetyBanDetail/add',
      method: 'post',
      data: data,
    })
  },
