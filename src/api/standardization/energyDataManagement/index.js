...
const api = {
  ...
  getList(query) {
    return request({
      url: '/api/v1/internal/tStdEnergy/getPageList',
      method: 'get',
      params: query,
    })
  },
  getEnergyStatus() {
    return request({
      url: '/api/v1/internal/tStdEnergy/getEnergyStatus',
      method: 'get',
    })
  },
  updateEnergyStatus(query) {
    return request({
      url: '/api/v1/internal/tStdEnergy/updateEnergyStatus',
      method: 'get',
      params: query,
    })
  },
  exportExcel(query) {
    return request({
      url: '/api/v1/internal/tStdEnergy/exportExcel',
      method: 'get',
      responseType: 'blob',
      params: query,
    })
  ...
  insert(data) {
    return request({
      url: `/api/v1/internal/tStdEnergy/addList`,
      method: 'post',
      data: data,
    })
  },
  ...
  deleteById(id) {
    return request({
      url: '/api/v1/internal/tStdEnergy/delete/' + id,
      method: 'delete'
    })
  },
  //删除
  ...
  downTemplate() {
    return request({
      url: '/api/v1/internal/tStdEnergy/downTemplate',
      method: 'get',
      responseType: 'blob',
    })
  },
  uploadFile(data) {
    return request({
      url: '/api/v1/internal/tStdEnergy/importList',
      method: 'post',
      data: data,
    })
  },
