...
const api = {
	...
	listWorkPlan(params) {
		return request({
			url: '/api/external/workTicketNew/listWorkPlan',
			method: 'get',
			params,
		})
	},
	...
	insertWorkTicket(data) {
		return request({
			url: '/api/external/workTicketNew/insertWorkTicket',
			method: 'post',
			data,
		})
	},
	lgInsertWorkTicket(data) {
		return request({
			url: '/api/external/workTicketNew/lgInsertWorkTicket',
			method: 'post',
			data,
		})
	},
	...
	getTicketInfo(data) {
		return request({
			url: `/api/external/workTicketNew/getTicketInfo?workPlanId=${data.workPlanId}&type=${data.type}&cargoCode=${data.cargoCode}&processCode=${data.processCode}`,
			method: 'get',
		})
	},
	getLgTicketInfo(data) {
		return request({
			url: `/api/external/workTicketNew/getLgTicketInfo?workPlanId=${data.workPlanId}&type=${data.type}&cargoCode=${data.cargoCode}&processCode=${data.processCode}`,
			method: 'get',
		})
	},
  // 根据workPlanId查询所有票货
  ...
  getDispatchAllList(params) {
	...
	getDeleteTicket(data) {
		return request({
			url: `/api/external/workTicketNew/deleteWorkTicket?workPlanId=${data.workPlanId}&type=${data.type}`,
			method: 'delete',
		})
	},
	// 审核作业票
	...
	getDepts(planType) {
		return request({
			url: '/api/external/workTicketNew/getDepts?type='+planType,
			method: 'get',
		})
	},
	// 获取操作工班
	getDepts1(planType) {
		return request({
			url: 'api/external/workTicket/getDepts?type='+planType,
			method: 'get',
		})
	},
	getDepts2(planType) {
  ...
  getSummaryQuantityTon(params){
    return request({
      url: `/api/external/workTicketNew/getSummaryQuantityTon`,
      method: 'get',
      params,
    })
  },
  ...
  reqGetWorkPlanList(params) {
    return request({
      url: '/api/external/workTicketNew/lgListWorkPlan',
      method: 'get',
      params,
    })
  },
