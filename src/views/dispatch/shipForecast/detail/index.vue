<template>
	<el-form :inline="true" label-position="top" :model="formData" :rules="rules" ref="ruleForm">
				...
				<el-row>
					...
					<el-col :span="6">
						<el-form-item label="国籍" prop="nationCode">
							<el-input v-model="formData.nationCode" disabled />
						</el-form-item>
					</el-col>
...
<!--					<el-col :span="6">-->
<!--						<el-form-item label="24小时确报时间" prop="confirmTime">-->
<!--							<nvDatePicker v-model:value="formData.confirmTime" typeFlag="nativedatetime" />-->
<!--						</el-form-item>-->
<!--					</el-col>-->
					<el-col :span="6">
						<el-form-item label="预抵日期" prop="arrivalTimePlan">
							<nvDatePicker v-model:value="formData.arrivalTimePlan" typeFlag="nativedatetime" />
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="预计离港时间" prop="leavePortTimePlan">
							<nvDatePicker v-model:value="formData.leavePortTimePlan" typeFlag="nativedatetime" />
							<!-- <el-date-picker
...
<!--					</el-col>-->
					...
					<el-col :span="6">
						<el-form-item label="是否开工" prop="isStartWork">
					...
					<el-col :span="6">
						<el-form-item label="是否收取停泊费" prop="berthingCharge">
	...
	<el-collapse v-model="collapseActiveNames">
		<el-collapse-item title="进出口信息" name="3">
			<el-row>
				<el-col :span="12">
					<el-form :inline="true" label-position="top" :model="inFormData" :rules="rules" ref="inRuleForm">
						<el-row>
							<el-col :span="12">
							...
							<el-col :span="12">
								<el-form-item label="进口装卸" prop="loadUnload">
									<el-input v-model="inFormData.loadUnload"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="一级货类" prop="firCargoCateName">
                  <el-input
                    v-model="inFormData.firCargoCateName"
                    placeholder="请输入一级货类"
                    disabled
                  />
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="二级货类" prop="secCargoCate">
                  <Select
                    :selectData="SEC_CARGO_CATE_LIST"
                    v-model:value="inFormData.secCargoCate"
                    v-model:label="inFormData.secCargoCateName"
                    :disabled="formData.impExp === 'OUT'"
                    @change="changeInSecCargo"
                  />
                </el-form-item>
              </el-col>
...
<!--              </el-col>-->
				...
				<el-col :span="12">
					<el-form :inline="true" label-position="top" :model="outFormData" :rules="rules" ref="outRuleForm">
						<el-row>
							<el-col :span="12">
							...
							<el-col :span="12">
								<el-form-item label="出口装卸" prop="loadUnload">
									<el-input v-model="outFormData.loadUnload"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="一级货类" prop="firCargoCateName">
                  <el-input
                    v-model="outFormData.firCargoCateName"
                    placeholder="请输入一级货类"
                    disabled
                  />
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="二级货类" prop="secCargoCate">
                  <Select
                    :selectData="SEC_CARGO_CATE_LIST"
                    v-model:value="outFormData.secCargoCate"
                    v-model:label="outFormData.secCargoCateName"
                    :disabled="formData.impExp === 'IN'"
                    @change="changeOutSecCargo"
                  />
                </el-form-item>
              </el-col>
...
const collapseActiveNames = reactive(['1', '2', '3'])
...
const rules = reactive({
  ...
  berthingCharge: proxy.getRules({ required: true }),
  isStartWork: proxy.getRules({ required: true }),
...
const changeImpExp = e => {
    ...
    outFormData.firCargoCateName = ''
    outFormData.firCargoCate = ''
    outFormData.secCargoCate = ''
    outFormData.secCargoCateName = ''
    ...
    outFormData.tradeType = formData.tradeType
		...
		inFormData.firCargoCateName = ''
		inFormData.firCargoCate = ''
		inFormData.secCargoCate = ''
		inFormData.secCargoCateName = ''
...
const getResidualAmount = async (type,customerId,companyId) =>{
  await api.getBankCustomerPrepayment({
    ...
    companyId : companyId?companyId:inFormData.companyId,
...
const changeAmountOut = e => {
  ...
  if(
    outFormData.customerId != null
    && outFormData.customerId != undefined
    && outFormData.customerId != ""
    && outFormData.companyId != null
    && outFormData.companyId != undefined
    && outFormData.companyId != ""
  ){
    outFormData.residualAmount = getResidualAmount("OUT",outFormData.customerId,outFormData.companyId);
  }
}
const changeAmountIn = e => {
    ...
    if(
      inFormData.customerId != null
      && inFormData.customerId != undefined
      && inFormData.customerId != ""
      && inFormData.companyId != null
      && inFormData.companyId != undefined
      && inFormData.companyId != ""
    ){
      inFormData.residualAmount = getResidualAmount("IN",inFormData.customerId,inFormData.companyId);
    }
}
const radioChange = () => {
...
const resetForm = type => {
    ...
    formData.isTrust = ""
		...
		for (const key in inFormData) {
			if (!keys.includes(key)) {
        inFormData[key] = ''
			}
		}
		for (const key in outFormData) {
			if (!keys.includes(key)) {
        outFormData[key] = ''
			}
		}
...
const changeInSecCargo = cargoObj => {
  console.log(cargoObj)
  if(cargoObj.firText == 'JZS01'){
    inFormData.firCargoCateName = '集装箱'
    inFormData.firCargoCate = '01'
  }else if(cargoObj.firText == 'GSH02'){
    inFormData.firCargoCateName = '干散货'
    inFormData.firCargoCate = '02'
  }else if(cargoObj.firText == 'YP03'){
    inFormData.firCargoCateName = '油品'
    inFormData.firCargoCate = '03'
  }else if(cargoObj.firText == 'JZH04'){
    inFormData.firCargoCateName = '件杂货'
    inFormData.firCargoCate = '04'
  }else if(cargoObj.firText == 'CL05'){
    inFormData.firCargoCateName = '车辆'
    inFormData.firCargoCate = '05'
  }

  // inFormData.firCargoCate = cargoObj.firText
}
const changeOutSecCargo = cargoObj => {
  console.log(cargoObj)
  if(cargoObj.firText == 'JZS01'){
    outFormData.firCargoCateName = '集装箱'
    outFormData.firCargoCate = '01'
  }else if(cargoObj.firText == 'GSH02'){
    outFormData.firCargoCateName = '干散货'
    outFormData.firCargoCate = '02'
  }else if(cargoObj.firText == 'YP03'){
    outFormData.firCargoCateName = '油品'
    outFormData.firCargoCate = '03'
  }else if(cargoObj.firText == 'JZH04'){
    outFormData.firCargoCateName = '件杂货'
    outFormData.firCargoCate = '04'
  }else if(cargoObj.firText == 'CL05'){
    outFormData.firCargoCateName = '车辆'
    outFormData.firCargoCate = '05'
  }
...
const init = () => {
  ...
  api.getSecCargoCateList().then(res => {
    SEC_CARGO_CATE_LIST.value = res.data
  })
}
init()
const initData = () => {
  nextTick(() => {
    isTrust(formData.id);
    publicApi.getRemoteSelect({ type: 'SHIP',valueContent:formData.shipId }).then(res => {
      let shipInfo = res.data[0]
      if(shipInfo){
        formData.shipWidth = shipInfo.shipWidth
        formData.netWeight = shipInfo.netWeight
        formData.shipLength = shipInfo.shipLength
        formData.dwt = shipInfo.dwt
        formData.captainPhone = shipInfo.captainPhone
        formData.callNo = shipInfo.callNo
        formData.totalWeight = shipInfo.totalWeight
        formData.imo = shipInfo.imo
        formData.fullLoadWater = shipInfo.fullLoadWater
        formData.emptyLoadWater = shipInfo.emptyLoadWater
      }
    })
  })
}
