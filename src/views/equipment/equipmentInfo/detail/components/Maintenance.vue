...
const tableColumns = ref([
	...
	{ label: '点检次数', prop: 'spotCheckCount', align: 'center',},
	{ label: '故障次数', prop: 'faultCount', align: 'center',  },
	{ label: '润滑保养次数', prop: 'lubricationCount', align: 'center',  },
])
...
const loadData = async () => {
	...
	try {
		...
		const res = await equipmentInfoApi.getMaintenanceByMonth(params)
		if (res.code === '0000') {
			// 确保 res.data 是数组
