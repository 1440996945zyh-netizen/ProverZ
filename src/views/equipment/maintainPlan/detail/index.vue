      ...
      <el-collapse-item title="计划信息" name="1">
            ...
            <el-col :span="8">
                ...
                />
				    ...
				    <el-col :span="8">
					    <el-form-item label="计划周期类型" prop="equipType">
					    	<Select
					    		:selectData="[
					    			{ label: '日', value: '1' },
					    			{ label: '周', value: '2' },
				    ...
				    <el-col :span="8" v-if="cycleTitle == '天'">
          			  ...
          			  <span>
										初始日期
          			    <el-tooltip lass="box-item" effect="dark" content="设置润滑保养计划/任务开始日期" placement="top">
            ...
            <el-col :span="8">
					    <el-form-item label="润滑保养人员" prop="inspectorId">
					    	<Select
...
const rules = reactive({
	...
	planType: proxy.getRules({ required: true }),
...
watch(() => formData.value.equipType, newV => {
	if (newV)
		equipTypeChange(newV)
})
// 类型change事件
