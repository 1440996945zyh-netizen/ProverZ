	...
	<div class="app-container equipment-change-apply">
		<el-card shadow="never" class="search-card">
			<el-form :model="searchForm" :inline="true">
				<el-form-item>
					<el-input v-model="searchForm.scrapCode" placeholder="工单号" clearable style="width: 150px" />
				</el-form-item>
				<el-form-item>
				...
				<el-form-item>
					<el-select
						v-model="searchForm.useOrgId"
						placeholder="所属部门"
						clearable
						filterable
						style="width: 150px"
						:disabled="!searchForm.useCompanyId"
					>
						<el-option
...
const searchParams = computed(() => ({
	scrapCode: searchForm.scrapCode,
	title: searchForm.title,
	useCompanyId: searchForm.useCompanyId,
	useOrgId: searchForm.useOrgId,
...
const handleReset = () => {
	searchForm.scrapCode = ''
	searchForm.title = ''
	searchForm.useCompanyId = null
	searchForm.useOrgId = null
