		...
		<el-row :gutter="20">
			...
			<el-col :span="20">
				<div class="selectBox">
					<div></div>
					<div>
						<el-button v-hasPermi="['equipment:maintainStandard:save']" type="primary" icon="CircleCheck" @click="doSave">保存</el-button>
    		  </div>
				</div>
				<EditTable
					ref="editTableRef"
...
import api from '@/api/equipment/maintainStandard/index'
...
const editRules = ref({
	...
	content: [{ required: true, message: '保养内容必须填写' }],
	standard: [{ required: true, message: '技术要求及标准必须填写' }],
})
// 获取级别名称
...
const tableColumns = reactive([
	...
	{ prop: 'content', label: '保养内容', editType: 'input', editRender: {}, align: 'left' },
	{ prop: 'standard', label: '技术要求及标准', editType: 'input', editRender: {}, align: 'left' },
	{
		prop: 'delete',
		label: '添加',
		align: 'center',
