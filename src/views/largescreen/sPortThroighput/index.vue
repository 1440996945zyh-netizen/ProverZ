<template>
  <div>
    ...
    <el-drawer v-model="cargoCategoryVisible" :title=title size="50%">
    ...
    <el-dialog type="primary" v-model="dialogVisible" title="港区吞吐量导入" width="35%" :before-close="handleClose">
      <el-upload
        ref="upload"
        action="#"
      ...
      >
        <!--accept 只接受某种格式的文件-->
        <el-button type="primary" style="margin-bottom: 20px">导入港区吞吐量</el-button>
...
import api from '@/api/largescreen/sPortThroighput/index.js'
...
const tableColumns = ref([
  {label: '港区', prop: 'portLabel'},
  {label: '时间类型', prop: 'dateTypeLabel'},
  {label: '时间', prop: 'dateTime',width: 160},
  {label: '货物类型', prop: 'cargoTypeLabel'},
  {label: '吨数', prop: 'ton'},
