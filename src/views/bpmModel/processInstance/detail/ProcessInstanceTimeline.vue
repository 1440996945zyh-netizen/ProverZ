...
<template>
  <el-timeline style="padding-top: 20px;">
    ...
    >
      <template #dot>
        <div
          style="position: absolute; left: -10px; top: -6px; border-radius: 50%; border: 1px solid #dedede; width: 30px; height: 30px; display: flex; justify-content: center; align-items: center; background-color: #3f73f7; padding: 5px;"
        >
          <img style="width: 100%; height: 100%;" :src="getApprovalNodeImg(activity.nodeType)" alt="" />
          <div
            v-if="props.showStatusIcon"
            style="position: absolute; top: 17px; left: 17px; border-radius: 50%; display: flex; align-items: center; padding: 1px; border: 2px solid #fff; border-style: solid;"
      ...
      <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 2px;" :id="`activity-task-${activity.id}-${index}`">
        <!-- 第一行：节点名称、时间 -->
        ...
        >
          ...
          <div
            ...
            :key="idx1"
            style="background-color: #f1f1f1; height: 35px; border-radius: 30px; display: flex; align-items: center; padding-right: 8px; color: #666; position: relative;"
          >
        ...
        <div v-else style="display: flex; align-items: center; flex-wrap: wrap; margin-top: 1px; gap: 2px;">
          ...
          <div v-for="(task, idx) in activity.tasks" :key="idx" style="display: flex; flex-direction: column; padding-right: 2px; gap: 2px;">
            <div
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style="position: absolute; top: 19px; left: 23px; border-radius: 50%; display: flex; align-items: center; padding: 1px; border: 2px solid #fff; border-style: solid;"
            ...
            <teleport defer :to="`#activity-task-${activity.id}-${index}`">
              <div
                ...
                "
                style="color: #a5a5a5; font-size: 13px; margin-top: 1px; width: 100%; background-color: #f8f8fa; padding: 8px; border-radius: 6px;"
              >
          ...
          >
            ...
            <div
              v-if="props.showStatusIcon"
              style="position: absolute; top: 20px; left: 24px; border-radius: 50%; display: flex; align-items: center; padding: 1px; border: 2px solid #fff; border-style: solid;"
