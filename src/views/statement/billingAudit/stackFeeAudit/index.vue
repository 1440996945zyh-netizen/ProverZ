    ...
    <el-collapse v-model="collapseOpen">
      ...
      <template v-slot:title>
        <div style="display: flex; justify-content: space-between; width: 95%">
          <div>结算历史</div>
          <div>
            <el-button type="primary" @click.stop="costDetail">
...
<script setup name="stackFeeAudit">
...
const tableColumns = ref([
  ...
  { label: 'SCN', prop: 'scn', width: 100 ,isHidden: isHiddenLJLS},
	...
	{ label: '件杂', prop: 'workTypeLabel', align:'center', width: 80 },
	...
	{ label: '装卸', prop: 'loadUnload', width: 80,align:'center' },
