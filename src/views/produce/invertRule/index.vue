...
const tableColumns = ref([
	...
	{ prop: 'emptyWeight', label: '空车重量不高于' },
	{ prop: 'heavyWeight', label: '重车重量不低于' },
			...
			return [
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Edit',
						permission: 'produce:invertRule:update', // 权限
					},
					{
						default: () => '编辑',
					}
				...
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Delete',
						permission: 'produce:invertRule:delete', // 权限
					},
					{
						default: () => '删除',
					}
...
const buttonList = reactive([
	{
		...
		click: () => add, // 回调函数
		permission: 'produce:invertRule:add', // 权限
	},
])
