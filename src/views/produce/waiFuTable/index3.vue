  ...
  <div class="formData" style="padding: 0px 0px">
    <SearchHeader ref="SearchHeaderRef" class="tab_header" :selectData="selectData" @searchClick="getList" :buttonList="buttonList" />
        ...
        <el-table ref="tableRef" :data="tableData"
          ...
          <el-table-column prop="workTon" show-overflow-tooltip label="作业量" width="200"/>
          ...
          <el-table-column prop="daoYunWeightGoods" label="其中倒运过磅量" width="130"/>
...
const bottomSpanMethod = ({row, column, rowIndex, columnIndex})=>{
  ...
  if (columnIndex === 10) {
    ...
    if (rowIndex > 0 && list[rowIndex - 1].groupId === row.groupId) {
      return {
        rowspan: 0,
        colspan: 0,
      }
