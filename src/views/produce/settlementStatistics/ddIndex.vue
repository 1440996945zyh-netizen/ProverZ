<template>
  <div class="formData" style="padding: 10px 10px 10px 10px">
    ...
    <el-table :data="tableData" :span-method="bottomSpanMethod" border style="width: 100%;margin-bottom: 8px" ref="jsdRef">
      ...
      <el-table-column prop="weightTon" label="过磅作业量" width="100"/>
...
const daoYunAudit=(type,value)=>{
  ...
  if(flag){
    var startDate = queryParams.value.startDate;
    console.log(startDate,'startDate')
    api.updateSettlementStatus(tableData.value,queryParams.value.startDate,"dd").then(res=>{getList(queryParams.value) })
  }
}
