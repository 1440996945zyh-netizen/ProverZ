    ...
    <div class="formData" style="padding: 5px 0px 0px 0px;height: 50px;">
      <el-row>
        ...
        <el-col :span="3" style="float: right;">
          <el-button type="danger" @click="daoYunAudit('WF','0')" style="float: right;margin-left: 10px">撤销</el-button>
          <el-button type="primary" @click="daoYunAudit('WF','1')" style="float: right;margin-left: 0px">审核</el-button>
        </el-col>
      </el-row>
    </div>
...
const daoYunAudit=(type,value)=>{
  ...
  if(flag){
    api.updateSettlementStatus(tableData.value,queryParams.value.startDate,"wf").then(res=>{getList(queryParams.value) })
  }
