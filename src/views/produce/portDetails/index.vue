...
const buttonList = reactive([
	{
		...
		click: () => add, // 回调函数
		disabled: false,
		permission: 'produce:portDetails:save', // 权限
	},
	{
		label: '详情', // 按钮名称
		type: 'primary', // 按钮类型
		...
		disabled: false,
		permission: 'produce:portDetails:detail', // 权限
	},
/*	{
		label: '清场', // 按钮名称
		type: 'primary', // 按钮类型
		...
		click: () => clean, // 回调函数
		disabled: false,
		permission: 'produce:portDetails:clean', // 权限
	},*/
	{
		label: '撤销清场', // 按钮名称
		type: 'primary', // 按钮类型
		...
		disabled: false,
		permission: 'produce:portDetails:revokeClean', // 权限
	},
	{
		label: '导出', // 按钮名称
		type: 'primary', // 按钮类型
		...
		disabled: false,
		permission: 'produce:portDetails:export', // 权限
	},
])
