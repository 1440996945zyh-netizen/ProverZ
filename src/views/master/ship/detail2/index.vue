...
<!--                  <RemoteSelect type="CUSTOMER_ALL" v-model:value="formData.applicationUnitCode" v-model:label="formData.applicationUnit" />-->
                <el-input v-model="formData.applicationUnit" placeholder="请输入数字" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
                ...
                <el-switch v-model="formData.status" active-value="0" inactive-value="1"></el-switch>
						...
						<el-col :span="6">
							<el-form-item label="附件信息" prop="">
								<Upload2 businessType="MASTER_SHIP_01" :businessId="formData.id" :showRemoveBtn="false" :showUploadBtn="false"  />
							</el-form-item>
						</el-col>
						<el-col :span="2">
...
import Upload2 from '@/components/Upload2/index.vue'
