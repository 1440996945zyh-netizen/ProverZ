      ...
      return [
        h(
          ElButton,
          {
            ...
            link: true,
            icon: 'Edit',
            permission: 'master:labor:update', // 权限
          },
          {
            default: () => '编辑',
          }
        ...
        h(
          ElButton,
          {
            ...
            link: true,
            icon: 'Operation',
            permission: 'master:labor:delete', // 权限
          },
          {
            default: () => '删除',
          }
...
const buttonList = reactive([
  {
    ...
    click: () => add, // 回调函数
    permission: 'master:labor:add', // 权限
  },
  {
    label: '重置密码', // 按钮名称
    type: 'primary', // 按钮类型
    ...
    permission: 'master:labor:resetPsd', // 权限
  },
])
...
const add = () => {
  ...
  nextTick(() => {
    drawerRef.value.resetForm() // 清空事件
    drawerRef.value.formData.remark = '' // 新建清空备注
