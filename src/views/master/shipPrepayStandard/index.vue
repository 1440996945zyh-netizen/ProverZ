...
<script setup name="shipPrepayStandard">
import BaseTable from '@/components/BaseTable/index.vue'
import detail from './detail/index.vue'
import api from '@/api/master/shipPrepayStandard/index.js'
...
const tableColumns = ref([
	...
	{ prop: 'dwtStart', label: '载重吨(开始)' },
	{ prop: 'dwtEnd', label: '载重吨(结束)' },
	{ prop: 'advancePayment', label: '预缴费用' },
	{
		prop: '',
		label: '操作',
		width: 'operate',
			...
			return [
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Edit',
						permission: 'master:shipPrepayStandard:update', // 权限
					},
					{
						default: () => '编辑',
					}
				...
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Delete',
						permission: 'master:shipPrepayStandard:delete', // 权限
					},
					{
						default: () => '删除',
					}
...
const buttonList = reactive([
	{
		...
		click: () => add, // 回调函数
		permission: 'master:shipPrepayStandard:add', // 权限
	},
])
