<template>
	<div class="formData">
      ...
      <el-form-item label="货物标识码" prop="sign">
				<el-input v-model="formData.sign" placeholder="请输入货物标识码" />
			</el-form-item>
			...
			<el-form-item label="理货方式" prop="tally">
				<Select
      ...
      <el-form-item label="计件工资类型(库场)" prop="yardSalaryType" style="width: 100%" v-if="false">
        <div style="width: 100%">
          <Select
      ...
      <el-form-item label="计件工资类型(调度)" prop="dispatchSalaryType" style="width: 100%" v-if="false">
        <div style="width: 100%">
          <Select
            :dataConfig="{ url: '/api/internal/public/getDictListByType/SALARY_TYPE' }"
      ...
      <el-form-item label="计件工资类型(流机)" prop="flowSalaryType" style="width: 100%" v-if="false">
        <div style="width: 100%">
          <Select
            :dataConfig="{ url: '/api/internal/public/getDictListByType/SALARY_TYPE' }"
      ...
      <el-form-item label="计件工资类型(固机)" prop="fixedSalaryType" style="width: 100%" v-if="false">
        <div style="width: 100%">
          <Select
            :dataConfig="{ url: '/api/internal/public/getDictListByType/SALARY_TYPE' }"
