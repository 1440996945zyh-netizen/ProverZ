...
const resetForm = () => {
  ...
  //   formData.rateName='', //费率名称
  //   formData.rateId='',
  //   formData.rateCode= '', //费率code
  //   formData.oldRate= '', //费率值
  //   formData.newRate= '', //新费率
  //   formData.cargoCode= '', //货物名称
  //   formData.amount= '', //票据金额
  //   formData.taxRate= '', //税率
  //   formData.mea= '', //数量
  //   formData.unitName= '', //单位name
  //   formData.unitCode= '',//单位code
  //   formData.taxAmount= '', //税额
  //   formData.remark= '', //备注
  //   formData.invoiceDetailId=''//发票子表id
}
onMounted(()=>{
  getRateList();
})
