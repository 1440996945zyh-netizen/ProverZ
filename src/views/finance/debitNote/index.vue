...
<template>
	<div class='app-container'>
		...
		/>
		<!--新增抽屉组件 -->
		<el-drawer v-model='addReceiptDrawer' title='新增借方票据信息' size='80%'>
...
const buttonList = reactive([
	{
		...
		click: () => add, // 回调函数
		permission: 'finance:debitNote:add' // 权限
	}
])
// 表格数据
const tableData = ref([])
			...
			return [
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Edit',
						permission: 'finance:debitNote:check' // 权限
					},
					{
						default: () => '查看'
					}
				...
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Delete',
						permission: 'finance:debitNote:handle' // 权限
					},
					{
						default: () => '作废'
					}
