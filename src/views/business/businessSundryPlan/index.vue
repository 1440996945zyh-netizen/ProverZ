...
<script setup name="businessSundryPlan">
...
import DrawerDetail from '../businessSundryPlan/drawer/index.vue'
  ...
  { label: '备注', prop: 'remark',width:100 },
	{
			...
			return [
				h(
					ElButton,
					{
						...
						link: true,
						icon: 'Edit',
						permission: 'business:businessSundryPlan:update', // 权限
					},
					{
						default: () => '编辑',
					}
				...
				h(
					ElButton,
					{
						...
						permission: 'business:businessSundryPlan:delete', // 权限
					},
					{
						default: () => '删除',
					}
        ...
        h(
          ElButton,
          {
            ...
            link: true,
            icon: 'Document',
            permission: 'business:businessSundryPlan:weightQuery', // 权限
          },
          {
            default: () => '过磅数据',
          }
        ...
        h(
          ElButton,
          {
            ...
            link: true,
            icon: 'View',
            permission: 'business:businessSundryPlan:examine', // 权限
          },
          {
            default: () => '审核',
          }
...
const buttonList = reactive([
	{
		...
		click: () => add, // 回调函数
		permission: 'business:businessSundryPlan:add', // 权限
	},
])
...
const getList = e => {
  ...
  queryParams.value = e
  queryParams.value.weightType = '2'
