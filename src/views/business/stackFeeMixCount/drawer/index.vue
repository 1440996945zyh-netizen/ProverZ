				...
				<el-row :gutter="20">
					<el-col :span="6">
						<el-form-item label="合同" prop="contractId">
							<div style="width: 100%">
								<Select
									:dataConfig="{ url: `/api/external/storageSettleMix/listContract?cargoInfoId=${formData.id?formData.id:0}&date=${formData.date===undefined||formData.date===null?'':formData.date}` }"
...
const isUserReduceChange = e =>{
  ...
  if(e.value=='1'){
    api.getReduceList(formData.value.id).then(res=>{
